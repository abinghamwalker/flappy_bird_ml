...
def draw_window(win, birds, base, pipes, score,gen,pipe_ind):
    ...
    score_label_gens = STAT_FONT.render("Gens: " + str(gen-1),1,(255,255,255))
    win.blit(score_label_gens, (10, 10))

    score_label_alive = STAT_FONT.render("Alive: " + str(len(birds)),1,(255,255,255))
    win.blit(score_label_alive, (10, 50))
